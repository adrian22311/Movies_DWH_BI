...
USE master
GO
IF EXISTS (SELECT * FROM sysdatabases WHERE name='Movies_dwh')
		DROP DATABASE Movies_dwh
GO
...
DECLARE @StartDate DATE = '18100101', @NumberOfYears INT = 290;
...
DECLARE @StartDate DATE = '89991231', @NumberOfYears INT = 1;
DECLARE @CutoffDate DATE = DATEADD(DAY, @NumberOfYears, @StartDate);
...
DECLARE @StartDate DATE = '17770101', @NumberOfYears INT = 1;
DECLARE @CutoffDate DATE = DATEADD(DAY, @NumberOfYears, @StartDate);
